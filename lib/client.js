 ...
 * ```
 */
var TogClient = /** @class */ (function () {
    /**
     * @param redisUrl The Redis connection string
     */
    function TogClient(redisUrl) {
     ...
     */
    TogClient.prototype.listFlags = function (namespace) {
     ...
     */
    TogClient.prototype.getFlag = function (namespace, name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    TogClient.prototype.saveFlag = function (flag) {
        return __awaiter(this, void 0, void 0, function () {
            var sanitized;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    TogClient.prototype.deleteFlag = function (namespace, name) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    TogClient.prototype.session = function (namespace, id, options) {
        return __awaiter(this, void 0, void 0, function () {
            var key, value;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @hidden
     */
    TogClient.prototype.getFlagByKey = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var value;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @hidden
     */
    TogClient.prototype.createSession = function (namespace, id, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.listFlags(namespace)];
                    case 1:
                        flags = (_a.sent())
     ...
     * @hidden
     */
    TogClient.prototype.saveSession = function (session, duration) {
        return __awaiter(this, void 0, void 0, function () {
            var key;
            return __generator(this, function (_a) {
                switch (_a.label) {
